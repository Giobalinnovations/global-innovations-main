      ...
      <div className="max-w-[1350px] mx-auto px-[15px]">
        <SlideUp>
          <div className="flex flex-col items-center">
            ...
            <p className="pt-7.5 pb-10 font-semibold text-center max-w-[679px]">
              Find All the crucial information you need to make an informed
              decision and know better how we can encourage your business to
              thrive.
            </p>
          </div>
        </SlideUp>
            ...
            {faqData.map(({ ans, id, question }) => {
              return (
                <SlideUp key={id} id={id}>
                  ...
                  >
                    <AccordionTrigger className="font-semibold border-none lg:px-7.5 px-4 lg:py-7.5 py-4 text-left [&[data-state=open]]:text-primary-foreground [&[data-state=closed]]:text-muted-foreground">
                      {question}
                    </AccordionTrigger>
