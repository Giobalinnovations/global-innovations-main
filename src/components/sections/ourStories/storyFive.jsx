...
const StoryFive = ({ counter, title, text1, text2 }) => {
  return (
    <section className="overflow-x-hidden lg:py-15 py-9">
          ...
          <div className="flex lg:flex-row flex-col justify-center 2xl:gap-[144px] xl:gap-20 lg:gap-10 gap-5">
            <div className=" max-w-[534px] relative ">
              <div className="relative ">
                <Image
                  src={'/images/resource/our-story5-4.png'}
                  width={510}
                  height={670}
                ...
                />
                <Image
                  src={'/images/resource/our-story5-2.png'}
                  width={510}
                  height={670}
                  sizes="(max-width:1024px) 100vw, 50vw"
                  alt="stroy background"
              ...
              <div className="absolute top-7">
                <Image
                  src={'/images/shapes/our-story5-1.png'}
                  width={138}
                  height={140}
                  alt="bg"
                />
              ...
              <div className="absolute -right-9 -top-12">
                <Image
                  src={'/images/shapes/our-story5-3.png'}
                  width={366}
                  height={307}
                  alt="bg"
            ...
            <div className="max-w-[683px] mt-8 ">
              <StoryContentOne title={title} text1={text1} text2={text2} />
              {counter && (
                <div className="flex flex-col md:flex-row gap-25 2xl:mt-24 mt-14">
