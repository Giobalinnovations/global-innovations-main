...
const StoryContentFour = () => {
  return (
    <SlideUp>
      <Title size={'5xl'}>
        Comprehensive Services To accelerate your
        <Highlight>Business Growth.</Highlight>
      </Title>
      <p className="pt-5">
        At Global Innovations, we offer a full spectrum of services to help your
        business succeed in the digital age. Offering advanced digital marketing
        strategies, we tailor our services to meet your unique needs and goals,
