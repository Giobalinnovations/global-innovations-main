    ...
    <section className="lg:pt-[120px] pt-16 lg:pb-15 pb-9">
      <div className="max-w-[1350px] mx-auto px-[15px]">
        <SlideUp>
          <div className="flex flex-col items-center">
            ...
            <Title size={'5xl'} className="max-w-[869px] pt-6 text-center">
              Diverse Digital Marketing services offered by Global Innovations
            </Title>
          </div>
        </SlideUp>
        <div className="lg:pt-7.5 pt-2">
          <SlideUp>
            <div
              className="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 gap-x-10
              ...
              {servicesDataTwo.map(
                ({ id, description, icon_1, service_name }) => {
                  return (
                    <div
                      key={id}
                      className="flex flex-col items-center pt-8 text-center lg:pt-15 lg:text-start lg:items-start group"
                    >
                      ...
                      <p className="pt-3 lg:pt-6">{description}</p>
                    </div>
                  );
                }
              )}
