...
import Textarea from '../ui/textareaTwo';
...
const ContactFormTwo = () => {
  return (
    <section className="container lg:mt-15 mt-9">
      <div
        className={cn(
          `max-w-[1320px] mx-auto lg:pt-20 pt-12 lg:pb-12.5 pb-10 rounded-[30px] bg-background drop-shadow-3xl -mb-28 lg:px-12.5 px-6 relative z-[1]`
        )}
      >
        <div className="flex lg:flex-row flex-col justify-between items-center gap-12.5 ">
          <div className="lg:w-[40%] w-full lg:pb-11">
            ...
            <Title size={'5xl'} className={`md:leading-[140%]`}>
              Request a free Audit of your website
            </Title>
            <p className={`font-semibold mt-4 max-w-[449px]`}>
