    ...
    <section className="pt-20 relative after:absolute after:z-[-1] after:left-0 after:top-0 after:w-full after:h-[calc(100vh-120px)] after:bg-background-linear">
      <div className="max-w-[1355px] mx-auto px-[15px]">
        <div className="grid xl:grid-cols-[auto_505px] lg:grid-cols-[auto_48%] items-center justify-between xl:gap-[82px] gap-8">
          <div className="">
            <Title size={'7.5xl'}>
              Empowering Your Future with Groundbreaking and Next Gen Solutions
            </Title>
          </div>
          <div>
            <p className="font-semibold">
              At Global Innovations, we bring your ideas to life with leading
              edge solutions designed to propel your growth. Discover seamless
              tailored services that scale with your success.
            </p>
        ...
        <PartnersSlider
          ...
          className={
            'shadow-[0px_4px_40px_0px_rgba(44,54,109,0.2509803922)] max-w-[1005px] mx-auto lg:-mt-14 -mt-6 z-[1] relative dark:bg-white'
          }
        />
      </div>
    </section>
