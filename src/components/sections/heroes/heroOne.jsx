...
const HeroOne = () => {
  ...
  return (
    <section className="relative pt-4 bg-background-linear lg:mb-15 mb-9">
        ...
        <div className="grid xl:grid-cols-[46%_53%] lg:grid-cols-[50%_auto] grid-cols-1 justify-between items-center">
          ...
          <div className="max-w-[690px] relative pt-6 pb-9 lg:pt-0 lg:pb-0">
            <div className="relative inline-block mb-2.5">
              <h5 className="sm:px-10 px-5 sm:text-lg text-base py-3.5 font-bold leading-[120%] bg-accent rounded-lg text-primary-foreground  inline-block">
                Hi there, Welcome to NextMarketing{' '}
              </h5>
              <Image
                src={'/images/shapes/welcome-icon1-1.png'}
                width={58}
                height={58}
                alt="walcome"
                className="absolute -right-7 -top-7 rotate-[21deg]"
              />
            </div>
            <Title size={'7.5xl'}>
              {' '}
            ...
            <p className="mt-[23px] font-semibold">
              Driving Conversions in the Digital Landscape — Our Expertise
              Ensures Your Brand Not Only Gets Noticed but Leaves a Lasting
              Impression
            </p>
            ...
            <form>
              ...
              <div className="flex items-center gap-2 mt-[15px]">
                <Image
                  src={'/images/shapes/info-icon1-1.svg'}
                  width={20}
                  height={20}
                  alt="infoicon"
                />
                <p className="text-sm ">
                  ...
                  <Link href={''} className="underline text-primary-foreground">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href={''} className="underline text-primary-foreground">
          ...
          <div className="relative flex justify-end w-full h-full">
            <div className="hidden sm:block">
              <div
                className="absolute  top-[147px] -left-8"
                style={{
                  transform: `translate(-${mousPositionX}px, -${mousPositionY}px)`,
                }}
              >
                <Image
                  src={'/images/shapes/balance-graph1-1.png'}
                  width={360}
                  height={169}
                  alt="balance-graph"
                  className={``}
                />
                <Image
                  src={'/images/shapes/telegram1-1.png'}
                  alt="telegram1"
                  width={70}
                  height={70}
              ...
              <div
                className="absolute z-[1] xl:bottom-[202px] bottom-25 xl:right-[161px] right-25"
                style={{
                  transform: `translate(${mousPositionX}px, ${mousPositionY}px)`,
                }}
              >
                <Image
                  src={'/images/shapes/chart-graph1-1.png'}
                  width={260}
                  height={98}
                  alt="chart-graph"
                />
                <Image
                  src={'/images/shapes/picture1-1.png'}
                  alt="telegram1"
                  width={70}
                  height={70}
              ...
              <Image
                src={'/images/shapes/mail1-1.png'}
                width={81}
                height={81}
                alt="chart-graph"
                className="absolute z-[1] bottom-[64px] left-0 xl:block hidden"
                style={{
                  transform: `translate(-${mousPositionX}px, -${mousPositionY}px)`,
                }}
              />
            ...
            <Image
              src={'/images/banner/wondered1-1.png'}
              priority={true}
              width={709}
              height={833}
