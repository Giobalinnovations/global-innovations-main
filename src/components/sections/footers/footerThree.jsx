  ...
  return (
    <footer className={cn(`lg:pt-15 pt-9`)}>
      <div className="container ">
        <div
          className={cn(
            `bg-[rgba(46,77,254,0.05)] rounded-tr-[30px] rounded-tl-[30px] pt-12.5 pb-[54px]  ${className}`
          )}
        >
          <div className="max-w-[1350px] mx-auto px-[15px]">
            ...
            <div className="grid xl:grid-cols-[auto_65%] lg:grid-cols-[auto_60%] grid-cols-1 gap-x-7 justify-between">
              <div>
                <h3 className="text-1xl font-semibold text-muted-foreground lg:pb-7.5 pb-3">
                  About
                </h3>
                <p className="pb-[38px]">
                  ...
                  measurable results. Our direction is innovation,
                  collaboration, and the achievement of effective success for
