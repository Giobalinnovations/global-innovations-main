      ...
      {search && (
        <div className="pb-12.5">
          ...
          <div className="relative">
            ...
            />
            <span className="absolute -translate-y-1/2 right-6 top-1/2">
                ...
                return (
                  <div key={id} className="flex items-center gap-[14px]">
                    <Image
                      ...
                      height={85}
                      alt="blog"
                      className="rounded-[5px] w-full lg:max-w-[136px] lg:min-w-[136px] min-w-25 max-w-25 max-h-[85px] object-cover"
                    />
                    <div>
                      <span className="text-sm text-[#7C848C] block pb-2">
                        {date}
                      </span>
                      <Link
                        href={'/blog-single-sidebar'}
                        className="text-muted-foreground multiline-hover"
                      >
